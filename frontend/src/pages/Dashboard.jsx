...
const Dashboard = ({ stats, boxes, loading, onRefresh }) => {
  ...
  const boxesNeedingReorder = boxes.filter(
    (b) =>
      b.prediction_status === "warning" &&
      b.days_until_reorder !== null &&
      b.days_until_reorder > 0,
  );
  ...
  const statCards = [
    ...
    },
    {
      ...
      icon: AlertTriangle,
      color:
        stats?.low_stock_count > 0 ? "text-orange-600" : "text-emerald-600",
  ...
  return (
    <div className="animate-fade-in" data-testid="dashboard">
      ...
      <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Overview of your box inventory
          </p>
        </div>
      ...
      {stats?.low_stock_count > 0 && (
        <div
          className="alert-banner p-4 mb-6 animate-fade-in"
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-orange-700 mt-1">
                {stats.low_stock_count} item(s) are below minimum threshold.
                Consider reordering:
              </p>
      ...
      {boxesNeedingReorder.length > 0 && (
        <div
          className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-6 animate-fade-in"
          data-testid="reorder-prediction-alert">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-amber-700 mt-1">
                Based on your usage patterns, these items will need reordering
                soon:
              </p>
              <div className="flex flex-wrap gap-2 mt-3">
          ...
          <Card
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                ...
                <div
                  className={`w-12 h-12 ${card.bg} flex items-center justify-center`}>
