...
import { ClipboardList, Minus, Plus, Calendar as CalendarIcon, Package } from "lucide-react";
...
const RecordUsage = ({ boxes, onUsageRecorded }) => {
  ...
  const totalBoxes = Object.values(usageEntries).reduce((sum, qty) => sum + qty, 0);
  ...
  return (
    <div className="animate-fade-in" data-testid="record-usage-page">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-1">Log how many boxes you used today</p>
      </div>
                  ...
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        Available: <span className="font-mono font-medium">{box.quantity}</span>
                        {usage > 0 && (
